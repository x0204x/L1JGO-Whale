...
// 火龍窟副本（MISS-P2-016）的三個 NPC 動作已遷移到 YAML+HTM 對話引擎：
//   46180 漢          → data/dialogs/46180_han/         （on_action a: give_item 80001 + set_cooldown）
//   46181 愛德納斯    → data/dialogs/46181_eldnas/      （on_action a: enter_dungeon 148）
//   46164 死亡騎士    → data/dialogs/46164_death_knight/（on_action enter: give_item 850 + in_dungeon 安全網）
// 不再需要 Go 端的 giveHansBag / enterFireDragonCave / giveFlameSword 包裝函式。
